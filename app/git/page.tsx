...
export default async function Git() {
  return (
    <div className="flex flex-col items-center px-4">
      ...
      <div className="p-4 md:p-5 bg-gray-100 sm:w-3/4 border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative  sm:group-even:pl-8 dark:text-white dark:bg-white/10 ">
